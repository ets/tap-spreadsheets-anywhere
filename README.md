...
- **full_table_replace**: (optional) Should the target table be fully replaced with new data. Defaults to false. Convenient if the extracted spreadsheet contains fewer lines than in a
previous sync.
